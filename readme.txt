...
__v2__ is coming.. It will include a better webRTC library powering the video chat(s), which should allow for better cross-browser compatibility, and less issuees.
